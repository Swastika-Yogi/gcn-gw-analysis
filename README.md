...
- **2026-08-22** — Wrote the catalog-validation finding, the missing-events investigation, and the corrected baseline explanation into the actual thesis documents: `feasibility_draft.md` (new Section 6), the LaTeX Results/Conclusion/Introduction chapters, and the abstract.
