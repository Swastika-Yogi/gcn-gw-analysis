...
\begin{enumerate}
    ...
    \item Test the resulting structural diagnosis directly, not just by argument, using real measured SNR from the public GWTC catalog cross-matched to circular event IDs.
